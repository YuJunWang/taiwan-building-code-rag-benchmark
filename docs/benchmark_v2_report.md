...
- **檢索上下文 (Context)**:
```text
【Agent 查閱路徑：okf_knowledge\建築技術規則建築設計施工編\第一章_用語定義\_index.md】
---
type: "moc"
folder: "第一章_用語定義"
---
...
- **檢索上下文 (Context)**:
```text
【Agent 查閱路徑：okf_knowledge\建築技術規則建築設計施工編\第一章_用語定義\第1條.md】
---
chapter: 第一章 用語定義
law: 建築技術規則建築設計施工編
related_articles:
...
六、觀眾席樓地板面積：觀眾席位及縱、橫通道之樓地板面積。但不包括吸煙室、放映室、舞臺及觀眾席外面二側及後側之走廊面積。
七、總樓地板面積：建築物各層包括地下層、屋頂突出物及夾層等樓地板面積之總和。
八、基地地面：基地整地完竣後，建築物外牆與地面接觸最低一側之水平面；基地地面高低相差超過三公尺，...
```
...
- **檢索上下文 (Context)**:
```text
【Agent 查閱路徑：okf_knowledge\建築技術規則建築設計施工編\第三章_建築物之防火\第一節_適用範圍\第63條.md】
---
title: "第63條"
law: "建築技術規則建築設計施工編"
chapter: "第三章 建築物之防火"
...
- **檢索上下文 (Context)**:
```text
【Agent 查閱路徑：okf_knowledge\建築技術規則建築設計施工編\第九章_容積設計\第162條.md】
---
chapter: 第九章 容積設計
law: 建築技術規則建築設計施工編
related_articles:
...
- **檢索上下文 (Context)**:
```text
【Agent 查閱路徑：okf_knowledge\建築技術規則建築設計施工編\第四章_防火避難設施及消防設備\第四節_緊急用昇降機\第106條.md】
---
title: "第106條"
law: "建築技術規則建築設計施工編"
...
- **檢索上下文 (Context)**:
```text
【Agent 查閱路徑：okf_knowledge\建築技術規則建築設計施工編\第六章_防空避難設備\第一節_（刪除）\第140條.md】
---
title: "第140條"
law: "建築技術規則建築設計施工編"
chapter: "第六章 防空避難設備"
section: "第一節 （刪除）"
related_articles: ["第一百四十一條"]
---
# 第140條
...
- **檢索上下文 (Context)**:
```text
【Agent 查閱路徑：okf_knowledge\建築技術規則建築設計施工編\第三章_建築物之防火\第四節_防火區劃\第86條.md】
---
title: "第86條"
law: "建築技術規則建築設計施工編"
chapter: "第三章 建築物之防火"
...
- **檢索上下文 (Context)**:
```text
【Agent 查閱路徑：okf_knowledge\建築技術規則建築設計施工編\第十二章_高層建築物\第三節_防火避難設施\第241條.md】
---
title: "第241條"
law: "建築技術規則建築設計施工編"
chapter: "第十二章 高層建築物"
...
- **檢索上下文 (Context)**:
```text
【Agent 查閱路徑：okf_knowledge\建築技術規則建築設計施工編\第六章_防空避難設備\第一節_（刪除）\第141條.md】
---
title: "第141條"
law: "建築技術規則建築設計施工編"
chapter: "第六章 防空避難設備"
...
- **檢索上下文 (Context)**:
```text
【Agent 查閱路徑：okf_knowledge\建築技術規則建築設計施工編\第十七章_綠建築基準\第一節_一般設計通則\第298條.md】
---
title: "第298條"
law: "建築技術規則建築設計施工編"
chapter: "第十七章 綠建築基準"
section: "第一節 一般設計通則"
related_articles: ["第二百九十九條"]
---
# 第298條
...
- **檢索上下文 (Context)**:
```text
【Agent 查閱路徑：okf_knowledge\建築技術規則建築設計施工編\第十章_無障礙建築物\_index.md】
---
type: "moc"
folder: "第十章_無障礙建築物"
---
...
- **檢索上下文 (Context)**:
```text
【Agent 查閱路徑：okf_knowledge\建築技術規則建築設計施工編\第四章_防火避難設施及消防設備\第六節_防火間隔\第110-1條.md】
---
title: "第110-1條"
law: "建築技術規則建築設計施工編"
chapter: "第四章 防火避難設施及消防設備"
