...
為達到「100%零污染」，本次評估由 3 位 AI 專家 (Subagents) 分別負責一種架構，並在本地端嚴格執行，最後交由 Gemini 3.1 Pro 進行雙盲客觀評估。
...
- ⚖️ **Gemini 3.1 Pro評分**：**1.0** / 1.0
- 📝 **Gemini 3.1 Pro點評**：答案完美符合標準解答，精準點出「水平投影面積」。
...
- ⚖️ **Gemini 3.1 Pro評分**：**1.0** / 1.0
- 📝 **Gemini 3.1 Pro點評**：正確命中「百分之五」之要求。
...
- ⚖️ **Gemini 3.1 Pro評分**：**0.0** / 1.0
- 📝 **Gemini 3.1 Pro點評**：完全答非所問（回答防空避難設備）。
...
- ⚖️ **Gemini 3.1 Pro評分**：**0.0** / 1.0
- 📝 **Gemini 3.1 Pro點評**：回答1.5公尺，未命中木造等可燃材料需「超過6公尺」之標準。
...
- ⚖️ **Gemini 3.1 Pro評分**：**0.0** / 1.0
- 📝 **Gemini 3.1 Pro點評**：完全答非所問（回答防災中心）。
...
- 🤖 **最終答案**：
  > 應具有一小時以上之防火時效。
- ⚖️ **Gemini 3.1 Pro評分**：**1.0** / 1.0
- 📝 **Gemini 3.1 Pro點評**：正確命中「一小時以上防火時效」。
...
- ⚖️ **Gemini 3.1 Pro評分**：**0.0** / 1.0
- 📝 **Gemini 3.1 Pro點評**：完全答非所問（回答陽臺規定）。
...
- ⚖️ **Gemini 3.1 Pro評分**：**1.0** / 1.0
- 📝 **Gemini 3.1 Pro點評**：正確回答單車道3.5公尺、雙車道5.5公尺。
...
- ⚖️ **Gemini 3.1 Pro評分**：**0.0** / 1.0
- 📝 **Gemini 3.1 Pro點評**：完全答非所問（回答屋頂突出物）。
...
- ⚖️ **Gemini 3.1 Pro評分**：**1.0** / 1.0
- 📝 **Gemini 3.1 Pro點評**：正確說明未超過35公尺得計入，且交叉口免截角。
...
- ⚖️ **Gemini 3.1 Pro評分**：**0.0** / 1.0
- 📝 **Gemini 3.1 Pro點評**：答非所問（回答木造防火區劃）。
...
- ⚖️ **Gemini 3.1 Pro評分**：**0.5** / 1.0
- 📝 **Gemini 3.1 Pro點評**：指出須設置緊急用昇降機及1小時防火時效與排煙，但漏掉天花板裝修材料及防火門數量限制細節。
...
- ⚖️ **Gemini 3.1 Pro評分**：**1.0** / 1.0
- 📝 **Gemini 3.1 Pro點評**：完美涵蓋須設置、1小時防火時效、耐燃一級材料與排煙設備等要求。
...
- ⚖️ **Gemini 3.1 Pro評分**：**0.0** / 1.0
- 📝 **Gemini 3.1 Pro點評**：回答了供公眾使用建築物的出入口規定，並未針對地下室直通樓梯的總寬度作答。
...
- ⚖️ **Gemini 3.1 Pro評分**：**0.5** / 1.0
- 📝 **Gemini 3.1 Pro點評**：提到需依樓地板面積計算及1.2公尺限制，但未提及「以避難層為分界獨立核算」及「36公分」等核心數據。
...
- ⚖️ **Gemini 3.1 Pro評分**：**0.5** / 1.0
- 📝 **Gemini 3.1 Pro點評**：提到按營業部分面積寬60公分計算，但未命中「以避難層為分界獨立核算」及加嚴至「36公分」等核心數據。
...
- ⚖️ **Gemini 3.1 Pro評分**：**1.0** / 1.0
- 📝 **Gemini 3.1 Pro點評**：精準回答不超過建築面積12.5%。
...
- ⚖️ **Gemini 3.1 Pro評分**：**0.5** / 1.0
- 📝 **Gemini 3.1 Pro點評**：指出防火牆無開口之核心精神，但未提及其應突出建築物外牆面 50 公分等細節。
...
- ⚖️ **Gemini 3.1 Pro評分**：**0.5** / 1.0
- 📝 **Gemini 3.1 Pro點評**：點出防火牆突出外牆及無開口的時效要求，但遺漏了分戶牆得設開口的具體對比差異。
...
- ⚖️ **Gemini 3.1 Pro評分**：**0.5** / 1.0
- 📝 **Gemini 3.1 Pro點評**：列出三個重點，包含防火區劃與防災中心，但未提及「二方向避難原則」。
...
- ⚖️ **Gemini 3.1 Pro評分**：**0.5** / 1.0
- 📝 **Gemini 3.1 Pro點評**：命中特別安全梯與防火區劃，但未提及防災中心及二方向避難。
...
- ⚖️ **Gemini 3.1 Pro評分**：**0.5** / 1.0
- 📝 **Gemini 3.1 Pro點評**：命中二方向避難及特別安全梯、排煙設備，但未提到防災中心。
...
- ⚖️ **Gemini 3.1 Pro評分**：**1.0** / 1.0
- 📝 **Gemini 3.1 Pro點評**：完美涵蓋用途、樓層數、建築面積及容納人數四個判斷參數。
...
- ⚖️ **Gemini 3.1 Pro評分**：**0.5** / 1.0
- 📝 **Gemini 3.1 Pro點評**：提到用途及面積，但漏掉了「樓層數」及學校/工廠的「容納人數」參數。
...
- ⚖️ **Gemini 3.1 Pro評分**：**0.5** / 1.0
- 📝 **Gemini 3.1 Pro點評**：提到用途類別、樓層數及建築面積，但漏掉了學校/工廠的「容納人數」參數。
...
- ⚖️ **Gemini 3.1 Pro評分**：**0.5** / 1.0
- 📝 **Gemini 3.1 Pro點評**：命中遮陽設施及綠建築免計入之概念，但未命中突出物可放寬至30%等具體數據。
...
- ⚖️ **Gemini 3.1 Pro評分**：**0.5** / 1.0
- 📝 **Gemini 3.1 Pro點評**：命中放寬至30%之規定，但未提及遮陽設施2.0公尺等細節條件。
...
- ⚖️ **Gemini 3.1 Pro評分**：**0.5** / 1.0
- 📝 **Gemini 3.1 Pro點評**：命中放寬至30%之規定，但未提及遮陽設施透空及深度的特定條件。
...
- ⚖️ **Gemini 3.1 Pro評分**：**0.5** / 1.0
- 📝 **Gemini 3.1 Pro點評**：僅敘述了需設置無障礙通路之大架構，但未命中坡度1:8、停車位數量等具體核心數據。
...
- ⚖️ **Gemini 3.1 Pro評分**：**0.5** / 1.0
- 📝 **Gemini 3.1 Pro點評**：提到需設置無障礙通路與車位，但給出的坡度為1:12，且未命中停車位數量規定。
...
- ⚖️ **Gemini 3.1 Pro評分**：**0.5** / 1.0
- 📝 **Gemini 3.1 Pro點評**：點出設置項目，但完全沒有給出如坡度1:8、停車位50輛等具體數據要求。
...
- ⚖️ **Gemini 3.1 Pro評分**：**0.5** / 1.0
- 📝 **Gemini 3.1 Pro點評**：說明了防火與非防火的差異及1.5公尺退縮，但未說明高度超過50公尺的落物曲線退縮規定及6公尺以上免不燃材料限制。
...
- ⚖️ **Gemini 3.1 Pro評分**：**0.5** / 1.0
- 📝 **Gemini 3.1 Pro點評**：提到了防火與非防火差異，但未給出具體退縮距離或高樓層落物曲線規定。
...
- ⚖️ **Gemini 3.1 Pro評分**：**0.5** / 1.0
- 📝 **Gemini 3.1 Pro點評**：提到了1.5公尺與3公尺退縮，但未提到高度超過50公尺的落物曲線退縮規定。

---

## 🔍 案例分析結論與點評 (Case Study & Conclusion)

透過精準的雙階段時間軸與嚴格的 Gemini 3.1 Pro 盲測，我們可以清楚看到：**「給 AI 什麼料，它就只能炒什麼菜」**。
