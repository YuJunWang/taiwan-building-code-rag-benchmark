...
為達到「100%零污染」，本次評估由 3 位 AI 專家 (Subagents) 分別負責一種架構，並在本地端嚴格執行，最後交由 gpt-oss-120b 進行 LangSmith 雙盲評估。
...
透過精準的雙階段時間軸與嚴格的 120B 法官盲測，我們可以清楚看到：**「給 AI 什麼料，它就只能炒什麼菜」**。
