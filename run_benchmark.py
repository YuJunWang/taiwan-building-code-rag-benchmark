...
for idx, q in enumerate(questions):
    print(f"Running q{idx+1}...", flush=True)
    try:
        result = subprocess.run(["python", "benchmark/retrieve_hybrid.py", q], capture_output=True, text=True, encoding='utf-8', errors='replace')
        outputs.append(f"=== Question {idx+1} ===\n{q}\n\n=== Context ===\n{result.stdout}\n=== Errors ===\n{result.stderr}\n\n")
...
with open('benchmark/hybrid_contexts.txt', 'w', encoding='utf-8') as f:
